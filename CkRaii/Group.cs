...
public static partial class CkRaii
{
    ...
    /// <inheritdoc cref="Group(uint, float, float, DFlags)"/>
    public static IEndObject Group(uint bgCol, DFlags flags = DFlags.None)
        => Group(bgCol, CkStyle.ChildRounding(), 0, flags);

    /// <inheritdoc cref="Group(uint, float, float, DFlags)"/>
    public static IEndObject Group(uint bgCol, float rounding, DFlags flags = DFlags.None)
    ...
    public static IEndObject Group(uint bgCol, float rounding, float frameThickness, DFlags flags = DFlags.None)
    {
