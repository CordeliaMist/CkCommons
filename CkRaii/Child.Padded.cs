...
public static partial class CkRaii
{
    ...
    public static IEOContainer FramedChildPaddedH(string id, float width, float height, uint bgCol, DFlags dFlags = DFlags.None, WFlags wFlags = WFlags.None)
        => FramedChildPaddedH(id, width, height, bgCol,  CkStyle.ChildRounding(), dFlags, wFlags);

    /// <inheritdoc cref="FramedChildPaddedH(string, float, float, uint, float, float, DFlags, WFlags)"/>/>
    public static IEOContainer FramedChildPaddedH(string id, float width, float height, uint bgCol, float rounding, DFlags dFlags = DFlags.None, WFlags wFlags = WFlags.None)
    ...
    /// </summary>
    /// <remarks> The passed in <paramref name="width"/> will have its winPaddingX appended before the child is made. </remarks>
    public static IEOContainer FramedChildPaddedH(string id, float width, float height, uint bgCol, float rounding, float thickness, DFlags dFlags = DFlags.None, WFlags wFlags = WFlags.None)
    ...
    public static IEOContainer FramedChildPaddedW(string id, float width, float height, uint bgCol, DFlags dFlags = DFlags.None, WFlags wFlags = WFlags.None)
        => FramedChildPaddedW(id, width, height, bgCol,  CkStyle.ChildRounding(), 2 * ImGuiHelpers.GlobalScale, dFlags, wFlags);

    /// <inheritdoc cref="FramedChildPaddedW(string, float, float, uint, float, float, DFlags, WFlags)"/>/>
    public static IEOContainer FramedChildPaddedW(string id, float width, float height, uint bgCol, float rounding, DFlags dFlags = DFlags.None, WFlags wFlags = WFlags.None)
    ...
    /// </summary>
    /// <remarks> The passed in <paramref name="height"/> will have its winPaddingY appended before the child is made. </remarks>
    public static IEOContainer FramedChildPaddedW(string id, float width, float height, uint bgCol, float rounding, float thickness, DFlags dFlags = DFlags.None, WFlags wFlags = WFlags.None)
    ...
    public static IEOContainer FramedChildPaddedWH(string id, Vector2 size, uint bgCol, DFlags dFlags = DFlags.None, WFlags wFlags = WFlags.None)
        => FramedChild(id, size, bgCol,  CkStyle.ChildRounding(), 2 * ImGuiHelpers.GlobalScale, dFlags, wFlags.WithPadding());

    /// <inheritdoc cref="FramedChildPaddedWH(string, Vector2, uint, float, float, DFlags, WFlags)"/>/>
    public static IEOContainer FramedChildPaddedWH(string id, Vector2 size, uint bgCol, float rounding, DFlags dFlags = DFlags.None, WFlags wFlags = WFlags.None)
    ...
    /// </summary>
    public static IEOContainer FramedChildPaddedWH(string id, Vector2 size, uint bgCol, float rounding, float thickness, DFlags dFlags = DFlags.None, WFlags wFlags = WFlags.None)
    ...
    public static IEOContainer FrameChildPadded(string id, Vector2 size, uint bgCol, DFlags dFlags = DFlags.None, WFlags wFlags = WFlags.None)
        => FrameChildPadded(id, size, bgCol,  CkStyle.ChildRounding(), dFlags, wFlags);

    /// <inheritdoc cref="FrameChildPadded(string, Vector2, uint, float, float, DFlags, WFlags)"/>/>
    public static IEOContainer FrameChildPadded(string id, Vector2 size, uint bgCol, float rounding, DFlags dFlags = DFlags.None, WFlags wFlags = WFlags.None)
    ...
    public static IEOContainer FrameChildPadded(string id, Vector2 size, uint bgCol, float rounding, float thickness, DFlags dFlags = DFlags.None, WFlags wFlags = WFlags.None)
